"""
Training script for SmallNet with kernel size 3*3 on cifar10
...
def train_cifar_models():
    ...
    train_cifar10_model(net, learning_rates=learning_rates, iters=iters,
                        output_path='results/models/tiny_cifar10_3_'+seed+'.model',
                        log_name='tiny_cifar10_3_'+seed)
    ...
    net.cuda()
    train_cifar10_model(net, learning_rates=learning_rates, iters=iters,
                        output_path='results/models/tiny_cifar10_3_enet_fc_' + seed + '.model',
                        log_name='tiny_cifar10_3_enet_fc_' + seed)
    ...
    net.cuda()
    train_cifar10_model(net, learning_rates=learning_rates, iters=iters,
                        output_path='results/models/tiny_cifar10_3_enet_cl_' + seed + '.model',
                        log_name='tiny_cifar10_3_enet_cl_' + seed)
    ...
    net.cuda()
    train_cifar10_model(net, learning_rates=learning_rates, iters=iters,
                        output_path='results/models/tiny_cifar10_3_enet_cl_fc_' + seed + '.model',
                        log_name='tiny_cifar10_3_enet_cl_fc_' + seed)
...
def evaluate_cifar_models():
    ...
    print('***  Baseline ***')
    evaluate_model(net=Cifar_Tiny(num_classes=10), path='results/models/tiny_cifar10_3_' + seed + '.model',
                             result_path='results/evals/tiny_cifar10_3_'+seed+'.pickle')

    print('***  ExpandNet-FC ***')
    evaluate_model(net=Cifar_Tiny_ExpandNet_fc(num_classes=10),
                             path='results/models/tiny_cifar10_3_enet_fc_' + seed + '.model',
                             result_path='results/evals/tiny_cifar10_3_enet_fc_' + seed + '.pickle')

    print('***  ExpandNet-CL ***')
    evaluate_model(net=Cifar_Tiny_ExpandNet_cl(num_classes=10),
                             path='results/models/tiny_cifar10_3_enet_cl_' + seed + '.model',
                             result_path='results/evals/tiny_cifar10_3_enet_cl_' + seed + '.pickle')

    print('***  ExpandNet-CL+FC ***')
    evaluate_model(net=Cifar_Tiny_ExpandNet_cl_fc(num_classes=10),
                             path='results/models/tiny_cifar10_3_enet_cl_fc_' + seed + '.model',
                             result_path='results/evals/tiny_cifar10_3_enet_cl_fc_' + seed + '.pickle')


if __name__ == '__main__':

    print('Training networks with 3*3 kernels on CIFAR-10')
